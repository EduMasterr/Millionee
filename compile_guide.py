...
files = [
    ("uploaded_media_1775521140014.img", "1_add_app.png"),
    ("uploaded_media_1775522181157.img", "2_register_web_app.png"),
    ("uploaded_media_1775522374012.img", "3_copy_config.png"),
    ("uploaded_media_1775523127570.img", "4_create_db_1.png"),
    ("uploaded_media_1775523618184.img", "5_create_db_2.png"),
    ("uploaded_media_1775524545397.img", "6_rules_true.png")
]
...
<body>
    <div class="container">
        ...
        <p style="text-align: center; font-size: 1.1rem; color: #aaa;">هذا الدليل تم بناؤه من الخطوات الحية التي قمت بها مع ترتيب الصور كمرجع دائم لك في المستقبل.</p>
        ...
        <div class="step">
            ...
            <img src="assets/guide_images/1_add_app.png" alt="تحديد الويب">
        </div>
        ...
        <div class="step">
            ...
            <img src="assets/guide_images/2_register_web_app.png" alt="تسجيل التطبيق">
        </div>
        ...
        <div class="step">
            ...
            <img src="assets/guide_images/3_copy_config.png" alt="نسخ الكود">
        </div>
        ...
        <div class="step">
            ...
            <img src="assets/guide_images/4_create_db_1.png" alt="قائمة البيانات">
            <img src="assets/guide_images/5_create_db_2.png" alt="إنشاء القاعدة">
        </div>
        ...
        <div class="step">
            ...
            <img src="assets/guide_images/6_rules_true.png" alt="نشر القواعد">
        </div>
